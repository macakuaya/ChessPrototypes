...
**Wrong Variation:** `Rh8+ Kxh8` — Black's king can capture the rook so this is not checkmate.
...
| Q# | FEN | Move | Theme |
|----|-----|------|-------|
| 1 | `6k1/5pp1/3b1n1p/1p6/1P1R4/6PP/5P2/6K1 w` | Rxd6 | Capture |
| 2 | `6k1/6p1/7p/2Q5/8/6P1/5P1P/4r1K1 w` | Kg2 | Escape check |
